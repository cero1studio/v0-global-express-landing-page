...
function readLeadEc() {
    ...
    ;
    try {
        const raw = sessionStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$repos$2f$GER$2d$filial$2f$v0$2d$global$2d$express$2d$landing$2d$page$2f$lib$2f$google$2d$enhanced$2d$conversions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GE_LEAD_EC_KEY"]);
        if (!raw) return null;
        sessionStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$repos$2f$GER$2d$filial$2f$v0$2d$global$2d$express$2d$landing$2d$page$2f$lib$2f$google$2d$enhanced$2d$conversions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GE_LEAD_EC_KEY"]);
...
function GraciasAnalytics() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$repos$2f$GER$2d$filial$2f$v0$2d$global$2d$express$2d$landing$2d$page$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GraciasAnalytics.useEffect": ()=>{
            ...
            ({
                "GraciasAnalytics.useEffect": async ()=>{
                    const userData = {};
                    if (lead?.email) {
                        const em = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$repos$2f$GER$2d$filial$2f$v0$2d$global$2d$express$2d$landing$2d$page$2f$lib$2f$google$2d$enhanced$2d$conversions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeEmailForHash"])(lead.email);
                        if (em) userData.sha256_email_address = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$repos$2f$GER$2d$filial$2f$v0$2d$global$2d$express$2d$landing$2d$page$2f$lib$2f$google$2d$enhanced$2d$conversions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sha256HexUtf8"])(em);
                    }
                    if (lead?.phoneE164 && lead.phoneE164.length > 4) {
                        userData.sha256_phone_number = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$repos$2f$GER$2d$filial$2f$v0$2d$global$2d$express$2d$landing$2d$page$2f$lib$2f$google$2d$enhanced$2d$conversions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sha256HexUtf8"])(lead.phoneE164);
                    }
                    ...
                    } else if (Object.keys(userData).length > 0 && w.gtag) {
                        // Sin AW configurado: envía user_data al stream GA para ayudar a detección automática de EC
                        w.gtag('set', 'user_data', userData);
                    }
                }
            })["GraciasAnalytics.useEffect"]().catch({
                "GraciasAnalytics.useEffect": ()=>{
                    if (adsConversionSendTo && w.gtag) {
...
//# sourceMappingURL=Documents_repos_GER-filial_v0-global-express-landing-page_747826ec._.js.map